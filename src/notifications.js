                ...
                <bs.Row>
                    ...
                    <bs.Col md={8} className="text-center" >
                        <bs.Card  className="shadow rounded p-4" style={messageCol}>
                            <bs.Card.Body>
                            <FA name="far fa-building"></FA><span className="border shadow p-3 m-3" > We saw that you are looking for a place where you can build your skills in Data Analyitics. We have a new crop of data that we are looking at this summer and we would love your help.</span>
                            </bs.Card.Body>
                        </bs.Card>
                    </bs.Col>
                </bs.Row>
